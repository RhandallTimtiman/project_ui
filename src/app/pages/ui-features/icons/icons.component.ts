...
export class IconsComponent {
  ...
  constructor(iconsLibrary: NbIconLibraries) {
    ...
    iconsLibrary.registerFontPack('regular', { packClass: 'far', iconClassPrefix: 'fa' });
    iconsLibrary.registerFontPack('solid', { packClass: 'fas', iconClassPrefix: 'fa' });
  }
  ...
  icons = {
    ...
    fontAwesome: [
      ...
      'briefcase', 'bug', 'building', 'bullhorn', 'graduation-cap'
    ],
